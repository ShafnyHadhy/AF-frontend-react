export default function Footer() {
    return (
        <>
            {/* Footer */}
            <footer className="border-t border-slate-200 bg-white pt-16 pb-8 dark:border-slate-800 dark:bg-[#111621]">
                ...
                <div className="mb-16 grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-5">
                    ...
                    <p className="mb-6 max-w-xs text-slate-500 dark:text-slate-400">
                        Empowering communities to reduce waste and extend the value of
                        their products through circular solutions.
                    </p>
                    ...
                    <div>
                    <h5 className="mb-6 font-bold text-slate-900 dark:text-white">
                        Platform
                    </h5>
                ...
                <div className="flex flex-col items-center justify-between gap-4 border-t border-slate-100 pt-8 dark:border-slate-800 md:flex-row">
                    ...
                    © 2024 Circularly. All rights reserved.
                    </p>
