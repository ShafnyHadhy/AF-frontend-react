            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 bg-white rounded-2xl p-6 shadow-soft border border-green-100">
                    ...
                    <div className="space-y-3">
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="flex items-center justify-between py-3 px-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-full bg-linear-to-br from-green-400 to-green-600"></div>
                                    <div>
                                        <p className="font-medium text-slate-900">Repair Request #{1000 + i}</p>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-soft border border-green-100">
                    ...
                    <div className="space-y-4">
                        <div className="p-3 bg-green-50 rounded-lg">
                            <p className="text-xs text-slate-600 uppercase tracking-wide">Response Time</p>
                            <p className="text-2xl font-bold text-green-600">12 min</p>
                        </div>
                        <div className="p-3 bg-green-50 rounded-lg">
                            <p className="text-xs text-slate-600 uppercase tracking-wide">This Week</p>
